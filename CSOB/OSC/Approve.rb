...
Switch(
    ...
    Patch(
        ...
        ),
        {
                ...
                Len(
                    Substitute(
                        Substitute(
                            ...
                            "Comments for Proposed solution section: ",
                            "",
                            1
                        ),
                        Char(10),
            ...
            //Old patch value: If(Len(input_DetailProposedSolution_comment_QRC.Text) > 0,Concatenate(varRecordQRC.'Proposed solution Comment',Char(10),User().FullName & "[" & varUserRole & "]" & "(" & Text(Today(),"dd.mm.yyyy") & "): " & input_DetailProposedSolution_comment_QRC.Text))
            'Relevant policies Comment': If(
                Len(
                    Substitute(
                        Substitute(
                            input_DetailRelevantPolicies_comment_QRC.Text,
                            "Comments for Relevant policies section: ",
                            "",
                            1
                        ),
                        Char(10),
                ...
                Len(
                    Substitute(
                        Substitute(
                            ...
                            "Comments for Mitigatin procedures section: ",
                            "",
                            1
                        ),
                        Char(10),
                ...
                Len(
                    Substitute(
                        Substitute(
                            ...
                            "Comments for Residual risk section: ",
                            "",
                            1
                        ),
                        Char(10),
                ...
                Len(
                    Substitute(
                        Substitute(
                            ...
                            "Comments for Decision proposal section: ",
                            "",
                            1
                        ),
                        Char(10),
                ...
                Len(
                    Substitute(
                        Substitute(
                            ...
                            "Comments for Risk statement section: ",
                            "",
                            1
                        ),
                        Char(10),
    ...
    Patch(
        ...
        {
            Status: If(
                varRecordQRC.Compliance = true Or chbx_complianceQRC.Value = true,
            ...
            'Compliance approver': If(
                chbx_complianceQRC.Value = true And Len(cbx_compliance_QRC.Selected.DisplayName) <> 0,
                {
                    DisplayName: cbx_compliance_QRC.Selected.DisplayName,
                    Claims: cbx_compliance_QRC.Selected.Mail,
                    Department: "",
                    Email: cbx_compliance_QRC.Selected.Mail,
                    JobTitle: "",
                    Picture: ""
                },
                varRecordQRC.'Compliance approver'
            ),
            Compliance: If(
                varRecordQRC.Compliance = false,
                chbx_complianceQRC.Value
            )
        }//;FormQRC_Attachments_edit.Updates
    ),
    "DATA Owner",
    ...
    Patch(
        ...
        ),
        {
            ...
            //'IRM approved': true;
            'Compliance comment': input_finalComment_QRC.Text,
